...
**The single highest-leverage fact:** ~25 tools render numeric input through one component, `InteractiveSlider.tsx`, and ~36 tools route their header/back/ad through `ToolHeader.tsx` + `BackButton.tsx`. Central fixes there cascade everywhere.
