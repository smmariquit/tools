...
Whenever you create or update a tool, you MUST include a "Related Tools" section at the bottom of the tool's interface (or blog post). This section should contain links to exactly 3 other tools on the platform that are contextually relevant (e.g., if it's the Salary Calculator, link to the 13th Month Pay, Income Tax, and Freelance Tax calculators).
