...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Replace the client ID with your actual Google AdSense publisher ID */}
        <Script
          async
          ...
          <header style={{ backgroundColor: "#ffffff", borderBottom: "1px solid var(--border-color)", padding: "16px 0" }}>
            <div className="container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <nav style={{ display: "flex", gap: "20px" }}>
                <Link href="/" style={{ color: "var(--text-secondary)", fontSize: "14px", fontWeight: 500 }}>All Tools</Link>
