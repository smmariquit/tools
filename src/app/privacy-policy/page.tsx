  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", paddingBottom: "40px" }}>
      ...
      <div className="card" style={{ color: "var(--text-primary)" }}>
        ...
        <p style={{ marginBottom: "16px" }}>
          We do not require you to create an account or provide personal information to use our standard calculators. The data you input into the calculators (such as salary amounts) is processed locally on your device or immediately discarded. We do not store your financial data on our servers.
        </p>

        <h2 style={{ fontSize: "18px", marginTop: "24px", marginBottom: "12px" }}>2. Log Files</h2>
        <p style={{ marginBottom: "16px" }}>
          PHTools follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.
        </p>
