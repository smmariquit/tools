...
export default function PromissoryNoteClient() {
	...
	return (
		<ToolLayout maxWidth="1200px">
			...
			{!hasAgreed ? (
				<div className="card" style={{ marginTop: "24px", border: "2px solid #ef4444", backgroundColor: "rgba(239, 68, 68, 0.05)" }}>
					<h2 style={{ fontSize: "20px", color: "#ef4444", marginBottom: "16px", display: "flex", alignItems: "center", gap: "8px" }}>
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
						{t("disclaimerTitle")}
					</h2>
					<p style={{ marginBottom: "12px", lineHeight: 1.6 }}>
						{t.rich("disclaimerP1", { strong: (chunks) => <strong>{chunks}</strong> })}
					</p>
					<p style={{ marginBottom: "16px", lineHeight: 1.6 }}>
						{t.rich("disclaimerP2", { strong: (chunks) => <strong>{chunks}</strong> })}
					</p>
					<div style={{ display: "flex", alignItems: "center", gap: "12px", marginTop: "24px", padding: "16px", backgroundColor: "var(--bg-color)", borderRadius: "8px", border: "1px solid var(--border-color)" }}>
						...
						<label htmlFor="agree" style={{ fontSize: "14px", fontWeight: "bold", cursor: "pointer" }}>{t("agreeLabel")}</label>
					</div>
				</div>
			) : (
			<div className="tool-grid" style={{ marginTop: "24px" }}>
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<div className="card">
						<h2 style={{ fontSize: "18px", marginBottom: "16px", color: "var(--primary)" }}>{t("contractParams")}</h2>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<div className="card" style={{ position: "sticky", top: "100px", backgroundColor: "var(--bg-color)" }}>
						<div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
							<h2 style={{ fontSize: "20px", color: "var(--primary)" }}>{t("generatedDocument")}</h2>
							<span style={{ fontSize: "12px", padding: "4px 8px", backgroundColor: "rgba(16, 185, 129, 0.1)", color: "#10b981", borderRadius: "4px" }}>{t("offlineSecure")}</span>
						</div>
