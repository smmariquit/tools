...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Calculate the 6% flat estate tax under the TRAIN Law, factoring in standard deductions and family home allowance.";
...
export default function EstateTaxPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/estate-tax-calculator" />
		</>
	);
}
