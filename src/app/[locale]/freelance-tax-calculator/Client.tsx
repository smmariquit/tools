		...
		<div style={{ maxWidth: "800px", margin: "0 auto" }}>
			<div style={{ marginBottom: "24px" }}>
				...
				<p className="page-subtitle">
					Calculate your net PHP after Upwork fees, forex spread, and the BIR 8%
						...
						<>
							...
							<div className="form-group" style={{ marginTop: "16px" }}>
								...
								<p className="form-hint" style={{ marginTop: "4px" }}>
									Banks typically take a ₱0.50 to ₱1.00 spread below the Google
									rate.
								</p>
							</div>
							<div
			...
			>
				...
				>
					<li>
						<strong>Upwork Fees:</strong> As of 2023, Upwork charges a flat 10%
						fee on all contracts, regardless of lifetime billings.
					</li>
					<li>
