...
export const metadata: Metadata = {
	...
	description:
		"Browse all free Philippine calculators and utilities by category.",
};
...
export default function CategoriesPage() {
	return (
		<div style={{ maxWidth: "1000px", margin: "0 auto", padding: "40px 20px" }}>
			...
			>
				Explore our deep, mathematically rigorous utilities divided by specific
				statutory and academic sectors.
			</p>
			<div
				style={{
					display: "grid",
