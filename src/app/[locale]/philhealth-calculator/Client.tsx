		...
		<div style={{ maxWidth: "800px", margin: "0 auto" }}>
			<div style={{ marginBottom: "24px" }}>
				...
				<p className="page-subtitle">
					Calculate your exact monthly PhilHealth premium based on the latest 5%
					rate scheduled by the Universal Health Care Act.
				</p>
			</div>
			...
			>
				...
				>
					...
					<li>
						<strong>Sharing:</strong> The total premium is split evenly (50/50)
