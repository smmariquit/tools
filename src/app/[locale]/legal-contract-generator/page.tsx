...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Generate standard Philippine legal documents (Lease Agreements, Promissory Notes) securely in your browser.";
...
export default function LegalContractPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/legal-contract-generator" />
		</>
	);
}
