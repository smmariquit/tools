			...
			{!hasAgreed ? (
				<div className="card" style={{ marginTop: "24px", border: "2px solid #ef4444", backgroundColor: "rgba(239, 68, 68, 0.05)" }}>
					...
					<p style={{ marginBottom: "12px", lineHeight: 1.6 }}>
						This tool is provided for <strong>educational and drafting purposes only</strong>. It does not constitute legal advice, nor does it create an attorney-client relationship.
					</p>
					<p style={{ marginBottom: "16px", lineHeight: 1.6 }}>
						The developers of PHTools <strong>assume absolutely no liability</strong> for the validity, enforceability, or consequences of using any documents generated by this tool. Laws and regulations change frequently, and you must consult with a licensed Philippine attorney (Notary Public) to ensure your document meets all legal requirements before execution.
					</p>
					<div style={{ display: "flex", alignItems: "center", gap: "12px", marginTop: "24px", padding: "16px", backgroundColor: "var(--bg-color)", borderRadius: "8px", border: "1px solid var(--border-color)" }}>
						...
						<label htmlFor="agree" style={{ fontSize: "14px", fontWeight: "bold", cursor: "pointer" }}>I have read and understood the disclaimer. I accept full responsibility for the use of this tool.</label>
					</div>
				</div>
			) : (
