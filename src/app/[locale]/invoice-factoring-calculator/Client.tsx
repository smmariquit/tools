		...
		<ToolLayout maxWidth="1200px">
			...
			<div className="tool-grid" style={{ marginTop: "24px" }}>
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<div className="card">
						<h2 style={{ fontSize: "18px", marginBottom: "16px", color: "var(--primary)" }}>{t("invoiceDetails")}</h2>
						...
						<div className="form-group" style={{ marginBottom: "16px" }}>
							<label className="form-label">{t("monthlyDiscountLabel")}</label>
							...
							<p style={{ fontSize: "12px", color: "var(--text-secondary)", marginTop: "4px" }}>{t("monthlyDiscountHint")}</p>
						</div>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<div className="card" style={{ position: "sticky", top: "100px", backgroundColor: "var(--bg-color)" }}>
						<h2 style={{ fontSize: "20px", marginBottom: "16px", color: "var(--primary)" }}>{t("factoringAnalysis")}</h2>
