...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Calculate standard creator rates based on engagement metrics (ER), follower count, and Philippine market multipliers.";
...
export default function InfluencerRatePage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/influencer-rate-calculator" />
		</>
	);
}
