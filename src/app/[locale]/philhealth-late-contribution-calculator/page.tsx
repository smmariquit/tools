...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Estimate interest penalties on missed PhilHealth premium payments for voluntary members.";
...
export default function PhilhealthLatePage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/philhealth-late-contribution-calculator" />
		</>
	);
}
