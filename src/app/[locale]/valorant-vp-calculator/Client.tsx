				...
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<div className="card">
						...
						<div className="form-group" style={{ marginBottom: "16px" }}>
							<label htmlFor="vp-amount" className="form-label">
								Valorant Points (VP) Needed
							</label>
							<input
								id="vp-amount"
								type="number"
								...
								value={vpAmount || ""}
								onChange={(e) => setVpAmount(Number(e.target.value))}
							/>
							<p
								style={{
									fontSize: "12px",
							...
							>
								E.g., 1775 for a Premium Skin, 4350 for a Bundle.
							</p>
						</div>
					</div>
				</div>
