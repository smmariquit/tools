		...
		<div style={{ maxWidth: "1200px", margin: "0 auto" }}>
			...
			<div className="tool-grid" style={{ marginTop: "24px" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					...
					<div className="card">
						...
						>
							Find out what average you need on your remaining units to hit your
							target GWA.
						</p>
						...
						{neededAverage !== null && (
							<div
								style={{
									marginTop: "16px",
									padding: "12px",
									backgroundColor: neededAverage < 1.0 ? "#ffebee" : "#fff8e1",
			...
			>
				...
				<p style={{ marginBottom: "16px" }}>
					...
					Philippines), PUP (Polytechnic University of the Philippines), and PLM
					(Pamantasan ng Lungsod ng Maynila) use an inverted grading system
					where <strong>1.00 is the highest grade</strong> (Excellent) and{" "}
					<strong>3.00 is the lowest passing grade</strong>. A grade of 5.00 is
					a failure.
				</p>
				<h3
