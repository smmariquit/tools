...
export const metadata = {
  ...
  description: "Calculate your General Weighted Average (1.0 to 5.0 scale) for UP, PUP, and other Philippine state universities. Includes a target GWA predictor.",
  alternates: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Calculate your General Weighted Average (1.0 to 5.0 scale) for Philippine state universities. Includes a target GWA predictor to see what grade you need.",
            operatingSystem: "All",
            offers: {
              "@type": "Offer",
              price: "0",
