		...
		<div style={{ maxWidth: "800px", margin: "0 auto" }}>
			...
			<div className="tool-grid" style={{ marginTop: "24px" }}>
				...
				<div className="card" style={{ backgroundColor: "var(--bg-color)" }}>
					...
					>
						{profitMargin > 0 ? "Margin: " : "Loss: "} {profitMargin.toFixed(1)}
						% of Item Price
					</div>
				</div>
			</div>
			...
			>
				...
				<p style={{ marginBottom: "16px" }}>
					Selling online in the Philippines involves several layers of fees. If
					you don&apos;t price your products correctly, you might end up losing
					money.
				</p>
				<ul
					style={{
				...
				>
					...
					<li>
						<strong>Commission Fee (3% - 5%):</strong> Charged by Shopee/Lazada
						for using their platform. Rate varies by product category.
					</li>
					<li>
				...
				<p style={{ fontSize: "12px", color: "var(--text-secondary)" }}>
					Note: Fees are subject to 12% VAT (already factored into the 2.24% and
					5.6% estimates above). Actual rates may slightly vary based on your
					seller tier (Mall, Preferred, or Non-Preferred) and category.
				</p>
			</div>
		</div>
	);
