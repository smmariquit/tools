...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Calculate your final pay, prorated 13th-month bonus, and unused SIL conversion for resigning or terminated employees in the Philippines.";
...
export default function FinalPayPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/final-pay-calculator" />
		</>
	);
}
