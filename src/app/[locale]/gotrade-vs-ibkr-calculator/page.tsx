...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Compare FX conversion spreads and trading fees to find the break-even deposit amount for GoTrade and Interactive Brokers (IBKR) in the Philippines.";
...
export default function GotradeIbkrPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/gotrade-vs-ibkr-calculator" />
		</>
	);
}
