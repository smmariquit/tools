		...
		<div style={{ maxWidth: "800px", margin: "0 auto" }}>
			<div style={{ marginBottom: "24px" }}>
				...
				<p className="page-subtitle">
					Calculate the monthly electricity cost of specific appliances (e.g.,
					Aircon, Refrigerator) based on their wattage.
				</p>
			</div>
				...
				<div className="card" style={{ alignSelf: "start" }}>
					...
					<div className="form-group">
						...
						<p className="form-hint" style={{ marginTop: "4px" }}>
							Usually found on the back sticker of the appliance (e.g., 1.0HP
							Aircon = ~1000W).
						</p>
					</div>
					...
					<div className="form-group" style={{ marginTop: "16px" }}>
						...
						/>
						<p className="form-hint" style={{ marginTop: "4px" }}>
							Check your latest Meralco bill for the exact blended rate.
						</p>
					</div>
				</div>
			...
			>
				<h2 style={{ fontSize: "24px", marginBottom: "16px" }}>
					How is Meralco Electricity Computed?
				</h2>
				<p style={{ marginBottom: "16px" }}>
					In the Philippines, electricity is billed based on{" "}
					<strong>Kilowatt-Hours (kWh)</strong>. The basic formula is:
				</p>
				<div
					style={{
						padding: "16px",
				...
				>
					Why does my Meralco bill fluctuate?
				</h3>
				<ul
					style={{
						paddingLeft: "24px",
				...
				>
					<li>
						<strong>Generation Charge:</strong> The cost of power purchased from
						suppliers changes monthly based on global fuel prices.
					</li>
					<li>
						<strong>System Loss Charge:</strong> Consumers pay for the power
						lost during transmission over the grid.
					</li>
					<li>
						<strong>Taxes and Subsidies:</strong> VAT, local franchise taxes,
						and lifeline subsidies are baked into the final per-kWh rate.
					</li>
				</ul>
			</div>
		</div>
