...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Calculate your potential year-end tax refund by reconciling your YTD withheld taxes against the TRAIN Law progressive brackets.";
...
export default function TaxRefundPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/tax-refund-calculator" />
		</>
	);
}
