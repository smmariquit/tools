...
export default function PdicClient() {
	...
	const uninsuredAmount =
		Math.max(0, singleAccounts - singleCoverage) +
		Math.max(0, jointAccounts - jointCoverage);
					...
					<div className="card">
						...
						<div className="form-group" style={{ marginBottom: "16px" }}>
							...
							<input
								...
								onChange={(e) => setSingleAccounts(Number(e.target.value))}
							/>
							<p
								style={{
									fontSize: "14px",
						...
						<div className="form-group" style={{ marginBottom: "16px" }}>
							...
							<input
								...
								className="form-control"
								value={jointAccounts || ""}
								onChange={(e) => setJointAccounts(Number(e.target.value))}
							/>
							<p
								style={{
									fontSize: "14px",
