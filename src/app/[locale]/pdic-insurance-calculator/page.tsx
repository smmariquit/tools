...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Calculate your maximum PDIC deposit insurance coverage (up to ₱500,000) for single and joint bank accounts.";
...
export default function PdicPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/pdic-insurance-calculator" />
		</>
	);
}
