		...
		<div style={{ maxWidth: "1200px", margin: "0 auto" }}>
			<div style={{ marginBottom: "24px" }}>
				...
				<p className="page-subtitle">
					Check TRB-approved toll fees for Skyway, SLEX, TPLEX, and other major
							...
							return (
								...
								>
									...
									<div style={{ display: "flex", gap: "12px" }}>
										...
										<div className="form-group" style={{ flex: 1 }}>
											<label className="form-label" htmlFor="exit-destination">
												Exit (Destination)
											</label>
											<select
												id="exit-destination"
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
					...
					<div className="card">
						...
						>
							...
							<li>
								<strong>Closed System (Tap on Entry, Pay on Exit):</strong> You
								tap your RFID or get a ticket at the entry point, and the system
								records where you came from. You only pay when you{" "}
						...
						>
							...
							experience both systems in a single trip. Make sure your RFID has
							enough balance for the sum of all systems.
						</p>
					</div>
				</div>
			</div>
