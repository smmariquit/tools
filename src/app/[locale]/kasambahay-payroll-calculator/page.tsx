...
export async function generateMetadata(): Promise<Metadata> {
	...
	const description = "Compute the SSS, PhilHealth, and Pag-IBIG contributions for household employees based on the Batas Kasambahay.";
...
export default function KasambahayPayrollPage() {
	return (
		<>
			<Client />
			<ToolFooter currentPath="/kasambahay-payroll-calculator" />
		</>
	);
}
